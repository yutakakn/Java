...
public class QuitDialog extends Dialog
{
	public QuitDialog(Frame parent, boolean modal)
	{
		...
		yesButton.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));
		add(yesButton);
		yesButton.setFont(new Font("Dialog", Font.BOLD, 12));
		yesButton.setBounds(36,84,79,22);
		noButton.setLabel("NO");
		noButton.setCursor(java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.HAND_CURSOR));
		add(noButton);
		noButton.setFont(new Font("Dialog", Font.BOLD, 12));
		noButton.setBounds(180,84,79,22);
		label1.setText("Exit this application?");
		label1.setAlignment(java.awt.Label.CENTER);
		add(label1);
		label1.setFont(new Font("MonoSpaced", Font.PLAIN, 16));
		label1.setBounds(60,36,180,23);
		setTitle("Java Binary Editor [EXIT]");
		//}}
